...
export default function Semester5Page({ onNavClick }) {
    return (
        <section className="page active">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-slate-800">Semester 5 Subjects</h1>
                <p className="mt-2 text-slate-500">Explore your subjects for Semester 5.</p>
            </div>
