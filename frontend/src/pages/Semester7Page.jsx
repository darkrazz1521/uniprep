...
export default function Semester7Page({ onNavClick }) {
    return (
        <section className="page active">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-slate-800">Semester 7 Subjects</h1>
                <p className="mt-2 text-slate-500">Explore your subjects for Semester 7.</p>
            </div>
